...
export default function Home() {
	return (
		<>
			<div className='rounded-b-lg border border-t-0 border-[#dbdbdb] dark:border-[#181818] bg-gradient-to-r from-bodyOne to-bodyTwo dark:from-navOne dark:to-navTwo grid grid-cols-2 gap-x-4 p-5'>
